...
const SignUp = () => {
  ...
  async function sendData(e) {
    ...
    try {
      const res = await axios.post('https://xenonstack-sp.herokuapp.com/api/register', { 
  ...
  return (
    <div className='signin signup'>
      ...
      <div className='new-to-xenonstack'>
        <p><span>Already registered at XenonStack?</span></p>
        <NavLink to='/login'>
